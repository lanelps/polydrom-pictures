...
const Container = tw.article`relative sm-t:absolute sm-t:right-4 w-max flex gap-x-[0.11rem] sm-t:gap-x-[0.1875rem] p-[0.125rem] sm-t:p-1 ml-3 sm-t:m-0 rounded bg-offwhite transition-colors z-50`;
