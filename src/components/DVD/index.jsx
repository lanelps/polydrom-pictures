...
const Container = styled.div(({ position }) => [
  tw`fixed w-auto max-w-[5.25rem] sm-t:max-w-[10.25rem] flex items-center justify-center z-30 mix-blend-difference opacity-0 animate-appear animation-delay-1000`,
  css`
